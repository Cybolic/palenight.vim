...
if has("nvim")
  ...
  call s:h("TSError", { "fg": s:dark_red })
  call s:h("TSPunctDelimiter", { "fg": s:white })
  call s:h("TSPunctBracket", { "fg": s:white })
  call s:h("TSPunctSpecial", { "fg": s:dark_yellow })
  call s:h("TSConstant", { "fg": s:cyan })
  call s:h("TSConstBuiltin", { "fg": s:cyan })
  call s:h("TSConstMacro", { "fg": s:cyan })
  call s:h("TSStringRegex", { "fg": s:green })
  call s:h("TSString", { "fg": s:green })
  call s:h("TSStringEscape", { "fg": s:dark_yellow })
  call s:h("TSCharacter", { "fg": s:green })
  call s:h("TSNumber", { "fg": s:dark_yellow })
  call s:h("TSBoolean", { "fg": s:red })
  call s:h("TSFloat", { "fg": s:dark_yellow })
  call s:h("TSAnnotation", { "fg": s:yellow })
  call s:h("TSAttribute", { "fg": s:yellow })
  call s:h("TSNamespace", { "fg": s:red })
  call s:h("TSFuncBuiltin", { "fg": s:blue })
  call s:h("TSFunction", { "fg": s:blue })
  call s:h("TSFuncMacro", { "fg": s:blue_purple })
  call s:h("TSMethod", { "fg": s:blue })
  call s:h("TSField", { "fg": s:green })
  call s:h("TSConstructor", { "fg": s:blue_purple })
  call s:h("TSProperty", { "fg": s:green })
  call s:h("TSConditional", { "fg": s:purple })
  call s:h("TSParameter", { "fg": s:yellow })
  call s:h("TSParameterReference", { "fg": s:yellow })
  call s:h("TSRepeat", { "fg": s:purple })
  call s:h("TSLabel", { "fg": s:purple })
  call s:h("TSKeyword", { "fg": s:purple })
  call s:h("TSKeywordFunction", { "fg": s:blue_purple })
  call s:h("TSKeywordOperator", { "fg": s:purple })
  call s:h("TSOperator", { "fg": s:cyan })
  call s:h("TSException", { "fg": s:purple })
  call s:h("TSType", { "fg": s:yellow })
  call s:h("TSTypeBuiltin", { "fg": s:yellow })
  call s:h("TSStructure", { "fg": s:yellow })
  call s:h("TSInclude", { "fg": s:blue })
  call s:h("TSVariable", { "fg": s:red })
  call s:h("TSVariableBuiltin", { "fg": s:cyan })
  call s:h("TSText", { "fg": s:visual_grey })
  call s:h("TSStrong", { "fg": s:visual_grey })
  call s:h("TSEmphasis", { "fg": s:visual_grey })
  call s:h("TSUnderline", { "fg": s:visual_grey })
  call s:h("TSTitle", { "fg": s:visual_grey })
  call s:h("TSLiteral", { "fg": s:visual_grey })
  call s:h("TSURI", { "fg": s:dark_yellow })
  call s:h("TSTag", { "fg": s:purple })
